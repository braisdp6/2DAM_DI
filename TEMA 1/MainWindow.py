...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.frameConductores.sizePolicy().hasHeightForWidth())
        self.frameConductores.setSizePolicy(sizePolicy)
        ...
        self.lblHistorico = QtWidgets.QLabel(parent=self.frameConductores)
        self.lblHistorico.setGeometry(QtCore.QRect(480, 140, 61, 20))
